...
#include <sound/pcm.h>
#include <sound/soc.h>
#if !defined(CONFIG_MTK_LEGACY_EXTSPK) //ranyanhao add 20160223
...
#define AW8736_MODE_CTRL // AW8736 PA output power mode control */ //ranyanhao@wind-mobi.com 20160229 
