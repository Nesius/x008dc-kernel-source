...
//ranyanhao@wind-mobi.com 20160428 begin
#if defined CONFIG_WIND_E280L_FOR_PASS_CTCC
	level_1024 = (level_1024 * 40) / 100;
	if(level_1024 <= 25 && level_1024 > 0) {
		level_1024 = 25;
	}
#else
#if defined CONFIG_WIND_BACKLIGHT_CURVE
	if (level_1024 <= 40 && level_1024 > 0) {
		level_1024 = 25;
	}	
#endif
#endif
//ranyanhao@wind-mobi.com 20160428 end
